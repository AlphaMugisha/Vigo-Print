...
<head>
    ...
    <style>
        ...
        .sidebar { width: 260px; background: #111; color: white; height: 100vh; padding: 20px; box-sizing: border-box; position: fixed; }
        .sidebar h2 { color: #25D366; text-align: center; margin-bottom: 40px; font-size: 20px; }
        .sidebar a { display: block; color: #999; text-decoration: none; padding: 12px 15px; border-radius: 8px; margin-bottom: 8px; font-weight: 600; }
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="?section=reviews" class="<?= $section == 'reviews' ? 'active' : '' ?>"><i class="fas fa-star"></i> Reviews</a>
        <a href="?section=contact" class="<?= $section == 'contact' ? 'active' : '' ?>"><i class="fas fa-phone"></i> Contact Info</a>
        <a href="logout.php" style="color: #e74c3c; margin-top: 40px;"><i class="fas fa-sign-out-alt"></i> Logout</a>
    </div>
    ...
    <div class="main-content">
        ...
        <div class="grid-cards">
            <div class="card">
                <div class="card-label">Paragraph: Small Badge</div>
        ...
        <div class="grid-cards">
            <div class="card">
                <div class="card-label">Paragraph: About Title</div>
            ...
            <div class="card">
                <div class="card-label">Paragraph: Main Text 1</div>
            ...
            <div class="card">
                <div class="card-label">Paragraph: Main Text 2</div>
        ...
        <div class="grid-cards">
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    ...
                    <a href="delete_item.php?type=service&id=<?= $s['id'] ?>" class="btn btn-delete" onclick="return confirm('Delete this?')"><i class="fas fa-trash"></i> Delete</a>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
        ...
        <div class="grid-cards">
            ...
            <div class="card">
                ...
                <img src="<?= $p['image_url'] ?>" class="preview-img">
                <div class="card-content">
                ...
                <div class="card-footer">
                    ...
                    <a href="delete_item.php?type=portfolio&id=<?= $p['id'] ?>" class="btn btn-delete" onclick="return confirm('Delete this?')"><i class="fas fa-trash"></i> Delete</a>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
